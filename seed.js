...
async function createRecipes() {
  try {
    ...
    const filesPromise = recipeFiles.map(file => File.createRecipeFile(file))

    await Promise.all(filesPromise)

    // const files = createFiles(1, 'recipe_placeholder');
    ...
    //   RecipeFile.createRecipeFile(recipe_file)
    // });
